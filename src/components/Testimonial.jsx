...
const TestimonialCard = ({ testimonial }) => (
  <div className="bg-white rounded-xl p-6 shadow-md shadow-gray-700  flex flex-col items-center text-center font-[Eudoxus Sans] hover:translate-x-[2px] hover:translate-y-[2px] ease-in-out duration-700">
    ...
    <p className="text-[#747474] text-center text-pretty">{testimonial.feedback}</p>
  </div>
);
...
const TestimonialsSection = () => {
  return (
    <div id='testimonials' className="w-full bg-white py-14 px-4 sm:px-8 lg:px-16">
