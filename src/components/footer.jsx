...
const Footer = () => {
  return (
    <footer className="bg-[#096DA7] text-white py-8 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        
        <div className="flex flex-col">
          <h3 className="text-2xl font-bold mb-4">CTX-ION Analytics</h3>
          <p className="text-white">
            We provide high-quality chemical testing services, specializing in environmental, food, and phytochemical analysis href d#liver reliable results.
          </p>
        </div>
